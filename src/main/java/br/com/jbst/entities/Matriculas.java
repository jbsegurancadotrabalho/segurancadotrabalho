...
public class Matriculas {
	...
	@Column(name = "uuid_pasta_empresa", length = 100)
	private String uuidPastaEmpresa;

	@Column(name = "uuid_pasta_matriculas", length = 100)
	private String uuidPastaMatriculas;

	@Column(name = "uuid_pasta_funcionario", length = 100)
	private String uuidPastaFuncionario;

	@Column(name = "uuid_documento_d4sign", length = 100)
	private String uuidDocumentoD4Sign;

	@Column(name = "uuid_signatario_funcionario", length = 100)
	private String uuidSignatarioFuncionario;

	@Column(name = "documento_assinado_funcionario")
	private byte[] documentoAssinadoFuncionario;
	...
	@OrderBy("ordem ASC")
	private List<AssinaturaAlunoD4Sign> assinaturaAluno;


	public byte[] getAssinaturaAlunoD4Sign() {
		if (this.assinaturaAluno != null && !this.assinaturaAluno.isEmpty()) {
			return this.assinaturaAluno.get(0).getImagem();
		}
		return null;
	}
